...
/**
 * This class represents a small sized ship
 * @author mpronoitis
 */
public class SmallShip extends Ship {
    /**
     * Constructor of SmallShip for player
     ...
     */
    public SmallShip(int selected, int positioned, int rotation, int rowOnBoard, int colOnBoard, String player, ShipsToBePlacedPane stbpPane, int row, YourBoardPane boardPane, ShipsPlacementFrame spFrame) {
    ...
    /**
     * Constructor of SmallShip for PC
     * @param player: name of the player
     */
    public SmallShip(String player) {
        super(player);
        shipBtns = new JButton[size];
        for (int i = 0; i < size; i++) {
            shipBtns[i] = new JButton();
