...
/**
 * This class represents a medium sized ship
 * @author mpronoitis
 */
public class MediumShip extends Ship {
    /**
     * Constructor of MediumShip for player
     ...
     */
    public MediumShip(int selected, int positioned, int rotation, int rowOnBoard, int colOnBoard, String player, ShipsToBePlacedPane stbpPane, int row, YourBoardPane boardPane, ShipsPlacementFrame spFrame) {
    ...
    /**
     * Constructor of MediumShip for PC
     * @param player: name of the player
     */
    public MediumShip(String player) {
        super(player);
        shipBtns = new JButton[size];
        for (int i = 0; i < size; i++) {
            shipBtns[i] = new JButton();
