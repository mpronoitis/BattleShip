...
/**
 * This class represents a big sized ship
 * @author mpronoitis
 */
public class BigShip extends Ship {
    /**
     * Constructor of BigShip for player
     ...
     */
    public BigShip(int selected, int positioned, int rotation, int rowOnBoard, int colOnBoard, String player, ShipsToBePlacedPane stbpPane, int row, YourBoardPane boardPane, ShipsPlacementFrame spFrame) {
    ...
    /**
     * Constructor of BigShip for PC
     * @param player: name of the player
     */
    public BigShip(String player) {
        super(player);
        shipBtns = new JButton[size];
        for (int i = 0; i < size; i++) {
            shipBtns[i] = new JButton();
    ...
    /**
     * This method adds a Select Listener on each button of the ship
     */
